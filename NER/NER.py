...
def estimateTime(numDocuments = 100):
    ...
    for k in range(numDocuments):
        ...
        with open('Decision_files/' + ('_').join(data[k]["doc_id_from"].split('/')) + '.txt',
            ...
            for line in file:
                ...
                wholeTime = wholeTime + (start - end)
    wholeTime = wholeTime / numDocuments
    print("The average time per one document : " + wholeTime)
...
if __name__ == '__main__':
    ...
    batch_size = 20 # YOUR HYPERPARAMETER HERE
    n_epochs = 30 # YOUR HYPERPARAMETER HERE
    learning_rate = 0.001 # YOUR HYPERPARAMETER HERE
    dropout_keep_prob = 0.5 # YOUR HYPERPARAMETER HERE

    #to restore the trained tework
